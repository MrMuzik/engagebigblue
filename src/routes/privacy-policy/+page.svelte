...
<section id="privacy-policy">
    <div class="container mx-auto py-20">
        ...
        <div class="font-sans bg-big-blue p-5 rounded-xl">
            ...
            <h2>Contact</h2>
            <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, email us at hello@engagebigblue.com or contact us at 210 Merit Drive, Shelby, NC, 28150, United States</p>
        </div>
    </div>
</section>